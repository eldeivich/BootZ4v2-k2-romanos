...
def romano_a_arabigo(numRomano):
    ...
    numRepes = 1
    ultimoCaracter = ''
    for letra in numRomano: # Recorrer de izquierda a derecha el número romano
        # Incrementamos el valor del númeor arábigo con el valor numérico del símbolo romano
        if letra in valores:
            ...
            if ultimoCaracter == '':
                ...
                numRepes = 1
        else:  # Si el símbolo romano no es permitido devolvemos error (0)
            return 0
